...
int main(int argc, char** argv) {
	...
	Vertex2DColor vertices[] = { 
		Vertex2DColor(glm::vec2(-0.5f, -0.5f), glm::vec3(0.f, 0.f, 1.f)), // 1
		Vertex2DColor(glm::vec2(-0.5f, +0.5f), glm::vec3(0.f, 0.f, 0.f)), // 2
		Vertex2DColor(glm::vec2(+0.5f, +0.5f), glm::vec3(1.f, 0.f, 0.f)), // 3
		Vertex2DColor(glm::vec2(-0.5f, -0.5f), glm::vec3(0.f, 0.f, 1.f)), // 4
		Vertex2DColor(glm::vec2(+0.5f, +0.5f), glm::vec3(1.f, 0.f, 0.f)), // 5
		Vertex2DColor(glm::vec2(+0.5f, -0.5f), glm::vec3(1.f, 1.f, 1.f)) // 6
	};
