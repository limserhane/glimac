...
int main(int argc, char** argv) {
	...
	while(!done) {
		...
		glUniformMatrix4fv(earthProgram.uMVMatrix, 1, false, glm::value_ptr(sphereMVMatrix));
		glUniformMatrix4fv(earthProgram.uNormalMatrix, 1, false, glm::value_ptr(sphereNormalMatrix));
		glUniformMatrix4fv(earthProgram.uMVPMatrix, 1, false, glm::value_ptr(projectionMatrix * sphereMVMatrix));
		...
		for(auto randomDirection : moonParameters)
		{
			...
			glUniformMatrix4fv(moonProgram.uMVMatrix, 1, false, glm::value_ptr(moonMVMatrix));
			glUniformMatrix4fv(moonProgram.uNormalMatrix, 1, false, glm::value_ptr(moonNormalMatrix));
			glUniformMatrix4fv(moonProgram.uMVPMatrix, 1, false, glm::value_ptr(projectionMatrix * moonMVMatrix));
