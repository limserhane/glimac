...
int main(int argc, char** argv) {
	...
	GLuint lightDirectionUniform = glGetUniformLocation(program.getGLId(), "uLightDir_vs");
	...
	glUniform3f(lightIntensityUniform, 1, 1, 1);
	...
	while(!done) {
		...
		lightDirection_vs = viewMatrix * glm::rotate(glm::mat4(1.0f), 0.5f * windowManager.getTime(), glm::vec3(0, 1, 0)) * glm::vec4(1, 1, 1, 0);
		glUniform3f(lightDirectionUniform, lightDirection_vs.x, lightDirection_vs.y, lightDirection_vs.z);
